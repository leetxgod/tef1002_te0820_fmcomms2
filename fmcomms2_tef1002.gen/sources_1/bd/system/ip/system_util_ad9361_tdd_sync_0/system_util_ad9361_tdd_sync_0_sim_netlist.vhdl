...
architecture STRUCTURE of system_util_ad9361_tdd_sync_0_util_pulse_gen is
  ...
  signal \pulse_period_d[7]_i_2_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_3_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_4_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_5_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_6_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_7_n_0\ : STD_LOGIC;
  signal \pulse_period_d[7]_i_8_n_0\ : STD_LOGIC;
...
pulse_period_cnt0_carry: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7) => \pulse_period_cnt_reg_n_0_[8]\,
      DI(6) => \pulse_period_cnt_reg_n_0_[7]\,
      DI(5) => \pulse_period_cnt_reg_n_0_[6]\,
      DI(4) => \pulse_period_cnt_reg_n_0_[5]\,
...
\pulse_period_cnt0_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7) => \pulse_period_cnt_reg_n_0_[16]\,
      DI(6) => \pulse_period_cnt_reg_n_0_[15]\,
      DI(5) => \pulse_period_cnt_reg_n_0_[14]\,
      DI(4) => \pulse_period_cnt_reg_n_0_[13]\,
...
\pulse_period_cnt0_carry__1\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7) => \pulse_period_cnt_reg_n_0_[24]\,
      DI(6) => \pulse_period_cnt_reg_n_0_[23]\,
      DI(5) => \pulse_period_cnt_reg_n_0_[22]\,
      DI(4) => \pulse_period_cnt_reg_n_0_[21]\,
...
\pulse_period_cnt0_carry__2\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 6) => B"00",
      DI(5) => \pulse_period_cnt_reg_n_0_[30]\,
      DI(4) => \pulse_period_cnt_reg_n_0_[29]\,
...
\pulse_period_d[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\pulse_period_d[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\pulse_period_d[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\pulse_period_d[7]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\pulse_period_d[7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\pulse_period_d[7]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\pulse_period_d[7]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\pulse_period_d[7]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of system_util_ad9361_tdd_sync_0 is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET rstn, FREQ_HZ 99999992, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_sys_ps8_0_pl_clk0, INSERT_VIP 0";
